...
strong_corr_xy = filter(corr_xy_df, corr_xy_df > 0.6)
strong_corr_xy
```
...
#### Part I.B EDA - (2.3) Categorical Predictor 3: GarageCars\
...
(1) PLS and PCR has comparably similar MSE, while Lasso Regression and Ridge Regression has comparably similar MSE.\
(2) Lasso and Ridge Regression's MSE much smaller than PLS and PCR's MSE.\
(3) Lasso has the lowest MSE value.\
